...
// node_modules/vue-ganttastic/dist/index.js
var require_dist = __commonJS({
  "node_modules/vue-ganttastic/dist/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    function _interopDefault(ex) {
      return ex && typeof ex === "object" && "default" in ex ? ex["default"] : ex;
    }
    var moment = _interopDefault((init_moment(), __toCommonJS(moment_exports)));
      ...
      methods: {
        initAxisDaysAndHours: function initAxisDaysAndHours() {
          ...
          while (start.isBefore(end)) {
            ...
            var endHour = start.day() === end.day() ? end.hour() - 1 : 23;
    ...
    function addStyle(id, css) {
      ...
      const style = styles[group] || (styles[group] = { ids: /* @__PURE__ */ new Set(), styles: [] });
      if (!style.ids.has(id)) {
        style.ids.add(id);
        let code = css.source;
        if (css.map) {
    ...
    var __vue_inject_styles__ = function __vue_inject_styles__2(inject) {
      if (!inject)
        return;
    ...
    var __vue_inject_styles__$1 = function __vue_inject_styles__2(inject) {
      if (!inject)
        return;
    ...
    }, __vue_inject_styles__$1, __vue_script__$1, __vue_scope_id__$1, __vue_is_functional_template__$1, __vue_module_identifier__$1, false, createInjector, void 0, void 0);
    var script$2 = {
      name: "GGanttBar",
      props: {
        bar: {
      ...
      methods: {
        ...
        manageOverlapping: function manageOverlapping() {
          ...
          var _this$getOverlapBarAn = this.getOverlapBarAndType(currentBar), overlapBar = _this$getOverlapBarAn.overlapBar, overlapType = _this$getOverlapBarAn.overlapType;
          while (overlapBar) {
    ...
    var __vue_inject_styles__$2 = function __vue_inject_styles__2(inject) {
      if (!inject)
        return;
    ...
    }, __vue_inject_styles__$2, __vue_script__$2, __vue_scope_id__$2, __vue_is_functional_template__$2, __vue_module_identifier__$2, false, createInjector, void 0, void 0);
    var script$3 = {
      name: "GGanttRow",
      components: {
      ...
      methods: {
        ...
        onDrop: function onDrop(e) {
          ...
          var bar = this.bars.find(function(bar2) {
            return time.isBetween(bar2[_this.barStart], bar2[_this.barEnd]);
          });
          this.$emit("drop", {
            event: e,
            bar,
    ...
    var __vue_inject_styles__$3 = function __vue_inject_styles__2(inject) {
      if (!inject)
        return;
    ...
    }, __vue_inject_styles__$3, __vue_script__$3, __vue_scope_id__$3, __vue_is_functional_template__$3, __vue_module_identifier__$3, false, createInjector, void 0, void 0);
    var script$4 = {
      name: "GGanttChart",
      components: {
      ...
      data: function data() {
        return {
          timemarkerOffset: 0,
          movedBarsInDrag: /* @__PURE__ */ new Set()
        };
      },
      computed: {
      ...
      methods: {
        ...
        initDragOfBarsFromBundle: function initDragOfBarsFromBundle(gGanttBar, e) {
          ...
          if (gGanttBar.barConfig.bundle !== null && gGanttBar.barConfig.bundle !== void 0) {
        ...
        shouldSnapBackBar: function shouldSnapBackBar(ganttBar) {
          if (this.snapBackOnOverlap && ganttBar.barConfig.pushOnOverlap !== false) {
            var _ganttBar$getOverlapB = ganttBar.getOverlapBarAndType(ganttBar.bar), overlapBar = _ganttBar$getOverlapB.overlapBar;
            return !!overlapBar;
          }
          return false;
        },
        ...
        onBarEvent: function onBarEvent(_ref, ganttBar) {
          var event = _ref.event, type = _ref.type, time = _ref.time;
        ...
        onDragendBar: function onDragendBar(e, ganttBar) {
          ...
          var movedBars = didSnapBack ? /* @__PURE__ */ new Set() : this.movedBarsInDrag;
          this.movedBarsInDrag = /* @__PURE__ */ new Set();
        ...
        setDragLimitsOfGanttBar: function setDragLimitsOfGanttBar(bar) {
          ...
          var _loop = function _loop2() {
            var side = _arr[_i];
            var _this4$countGapDistan = _this4.countGapDistanceToNextImmobileBar(bar, null, side, false), _this4$countGapDistan2 = _slicedToArray(_this4$countGapDistan, 2), totalGapDistance = _this4$countGapDistan2[0], bundleBarsOnPath = _this4$countGapDistan2[1];
            var _loop22 = function _loop23(i2) {
              var barFromBundle = bundleBarsOnPath[i2].bar;
              var gapDist = bundleBarsOnPath[i2].gapDistance;
              ...
              otherBarsFromBundle.forEach(function(otherBar) {
                var _this4$countGapDistan3 = _this4.countGapDistanceToNextImmobileBar(otherBar, gapDist, side), _this4$countGapDistan4 = _slicedToArray(_this4$countGapDistan3, 2), newGapDistance = _this4$countGapDistan4[0], newBundleBars = _this4$countGapDistan4[1];
        ...
        countGapDistanceToNextImmobileBar: function countGapDistanceToNextImmobileBar(bar, gapDistanceSoFar) {
          var side = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "left";
          var ignoreShadows = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true;
          var bundleBarsAndGapDist = bar.barConfig.bundle ? [{
            bar,
            gapDistance: gapDistanceSoFar
          }] : [];
          var currentBar = bar;
          var nextBar = this.getNextGanttBar(currentBar, side);
          if (side === "left") {
            while (nextBar) {
    ...
    var __vue_inject_styles__$4 = function __vue_inject_styles__2(inject) {
      if (!inject)
        return;
    ...
    }, __vue_inject_styles__$4, __vue_script__$4, __vue_scope_id__$4, __vue_is_functional_template__$4, __vue_module_identifier__$4, false, createInjector, void 0, void 0);
...
vue-ganttastic/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=vue-ganttastic.js.map
